...

{
    switch (estadoActualGAT) {
        ...
        case E_BAJANDO:
            ...
            } else if (tickRead() - tInicioGAT > 20 && PORTAbits.RA1 == 0) {
        ...
        case E_PRESIONADO:
            ...
            if (PORTAbits.RA1 == 0 && tickRead() - tInicioGAT > 40) {
                estadoActualGAT = E_MANTENIDO;
                if( BALAS_INF == 0)
                  cont_balas--;
                tInicioGAT = tickRead();
            }
        ...
        case E_SUBIENDO:
            ...
            else if (tickRead() - tInicioGAT > 40) {
                estadoActualGAT = E_SUELTO;
            }
            break;
        default:
